...
const static LPCTSTR g_szIPCSharedMMF = _T("{7a6840a5-7c29-4f20-8a4f-b4409404bab0}");
const static LPCTSTR g_szIPCMutex = _T("{9509dc94-af2e-4fe7-8ba7-327525a0819a}");
int oldcounter=0;
